...
try {
    // حذف الـ view الحالي
    $pdo->exec("DROP VIEW IF EXISTS `deals_with_users`");
    
    // إنشاء الـ view الجديد بدون العمود description
    $sql = "
    ...
    echo "✅ تم تحديث view deals_with_users بنجاح!\n";
    
} catch (Exception $e) {
    echo "❌ خطأ في تحديث الـ view: " . $e->getMessage() . "\n";
}
?>